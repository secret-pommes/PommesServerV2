...
express.use((req, res, next) => {
    if (!req.query.profileId && req.originalUrl.toLowerCase().startsWith("/lawinserver/fortnite/api/game/v2/profile/")) {
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetAffiliateName", async (req, res) => {
...
// Set STW banner
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetHomebaseBanner", async (req, res) => {
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetHomebaseName", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "profile0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/PurchaseHomebaseNode", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "profile0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UnlockRewardNode", async (req, res) => {
...
// Remove gift box
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/RemoveGiftBox", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetPartyAssistQuest", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
// Set pinned BR quest
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/AthenaPinQuest", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetPinnedQuests", async (req, res) => {
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/FortRerollDailyQuest", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/MarkNewQuestNotificationSent", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ClientQuestLogin", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
// Reset item STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/RefundItem", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/RefundMtxPurchase", async (req, res) => {
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/IncrementNamedCounterStat", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "profile0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ClaimLoginReward", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UpdateQuestClientObjectives", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
// Equip team perk STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/AssignTeamPerkToLoadout", async (req, res) => {
...
// Equip gadget STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/AssignGadgetToLoadout", async (req, res) => {
    const profile = require("./../profiles/campaign.json");
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/AssignWorkerToSquad", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "profile0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/AssignWorkerToSquadBatch", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "profile0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ClaimQuestReward", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
// Level item up STW 1
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UpgradeItem", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UpgradeSlottedItem", async (req, res) => {
...
// Level item up STW 2
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UpgradeItemBulk", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
// Evolve item STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ConvertItem", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ConvertSlottedItem", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "collection_book_people0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UpgradeItemRarity", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/PromoteItem", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
// Transform items STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/TransmogItem", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/CraftWorldItem", async (req, res) => {
    const memory = functions.GetVersionInfo(req);
...
// Destroy item STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/DestroyWorldItems", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "theater0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/DisassembleWorldItems", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "theater0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/StorageTransfer", async (req, res) => {
...
// Modify quickbar STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ModifyQuickbar", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "theater0"}.json`);
...
// Hero equipping STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/AssignHeroToLoadout", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ClearHeroLoadout", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
// Recycle items STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/RecycleItemBatch", async (req, res) => {
    const memory = functions.GetVersionInfo(req);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ResearchItemFromCollectionBook", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SlotItemInCollectionBook", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UnslotItemFromCollectionBook", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ClaimCollectionBookRewards", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/RespecAlteration", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UpgradeAlteration", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/RespecResearch", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/RespecUpgrades", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/PurchaseResearchStatUpgrade", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
// Upgrade levels STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/PurchaseOrUpgradeHomebaseNode", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetActiveHeroLoadout", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/ActivateConsumable", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/UnassignAllSquads", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
// Open llama STW
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/OpenCardPack", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/PopulatePrerolledOffers", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
    const ItemIDS = require("./../responses/ItemIDS.json");
...
// Purchase item
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/PurchaseCatalogEntry", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "profile0"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetItemFavoriteStatusBatch", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetItemFavoriteStatus", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
// Mark item as seen
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/MarkItemSeen", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
// Equip BR Locker 1
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/EquipBattleRoyaleCustomization", async (req, res) => {
...
// Set BR Banner 1
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetBattleRoyaleBanner", async (req, res) => {
    const profile = require("./../profiles/athena.json");
...
// Set BR Banner 2
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetCosmeticLockerBanner", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
// Set BR Locker 2
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetCosmeticLockerSlot", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/SetHeroCosmeticVariants", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "campaign"}.json`);
...
express.post("/lawinserver/fortnite/api/game/v2/profile/*/client/*", async (req, res) => {
    const profile = require(`./../profiles/${req.query.profileId || "athena"}.json`);
