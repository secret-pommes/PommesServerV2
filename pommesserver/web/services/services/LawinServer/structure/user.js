...
express.get("/lawinserver/account/api/public/account", async (req, res) => {
    var response = [];
...
express.get("/lawinserver/account/api/public/account/:accountId", async (req, res) => {
...
express.get("/lawinserver/account/api/public/account/*/externalAuths", async (req, res) => {
    res.json([])
})

express.delete("/lawinserver/account/api/oauth/sessions/kill", async (req, res) => {
    res.status(204);
    res.end();
})
...
express.get("/lawinserver/account/api/oauth/verify", async (req, res) => {
    res.json({
...
express.post("/lawinserver/account/api/oauth/token", async (req, res) => {
    if (config.Config.bUseConfigDisplayName == false) {
...
express.post("/lawinserver/account/api/oauth/exchange", async (req, res) => {
    res.json({})
})

express.get("/lawinserver/account/api/epicdomains/ssodomains", async (req, res) => {
    res.json([
        "unrealengine.com",
...
express.post("/lawinserver/fortnite/api/game/v2/tryPlayOnPlatform/account/*", async (req, res) => {
