...
express.get("/lawinserver/fortnite/api/version", async (req, res) => {
    res.json({
        "app": "fortnite",
...
express.get("/lawinserver/fortnite/api/v2/versioncheck/*", async (req, res) => {
    res.json({
        "type": "NO_UPDATE"
    })
})
...
express.get("/lawinserver/fortnite/api/versioncheck*", async (req, res) => {
    res.json({
        "type": "NO_UPDATE"
    })
})
