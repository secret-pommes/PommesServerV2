...
express.get("/lawinserver/friends/api/v1/*/settings", async (req, res) => {
    res.json({})
})

express.get("/lawinserver/friends/api/v1/*/blocklist", async (req, res) => {
    res.json([])
})

express.get("/lawinserver/friends/api/public/friends/:accountId", async (req, res) => {
...
express.get("/lawinserver/friends/api/v1/:accountId/summary", async (req, res) => {
...
express.get("/lawinserver/friends/api/public/list/fortnite/*/recentPlayers", async (req, res) => {
    res.json([])
})

express.get("/lawinserver/friends/api/public/blocklist/*", async (req, res) => {
    res.json({
        "blockedUsers": []
    })
})
