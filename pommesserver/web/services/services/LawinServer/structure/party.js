...
express.get("/lawinserver/party/api/v1/Fortnite/user/*", async (req, res) => {
    res.json({
        "current": [],
        "pending": [],
        "invites": [],
...
express.post("/lawinserver/party/api/v1/Fortnite/parties", async (req, res) => {
...
express.all("/lawinserver/party/api/v1/Fortnite/parties/*", async (req, res) => {
    res.status(204)
    res.end()
})
